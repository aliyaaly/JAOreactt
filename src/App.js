...
function App() {
    ...
    const handleDownloadPDF = async () => {
        ...
        contentClone.style.width = `${NATURAL.w}px`;
        contentClone.style.height = `${NATURAL.h}px`;

        document.body.appendChild(contentClone);

        try {
            const canvas = await window.html2canvas(contentClone, {
                scale: 2,
                useCORS: true,
                logging: false,
            });
            ...
            <main className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-8 pb-8">
                <div className="no-print">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
                            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                               ...
                               <div className="md:col-span-2">
                                     <Input label={t.fullName} value={resumeData.header.name} onChange={e => handleGenericChange('header', 'name', e.target.value)} />
                                     <Input label={t.jobPosition} value={resumeData.header.jobposition} onChange={e => handleGenericChange('header', 'jobposition', e.target.value)} />
                               </div>
                            </div>
                            <Input label={t.emailAddress} value={resumeData.header.email} onChange={e => handleGenericChange('header', 'email', e.target.value)} />
                            <Input label={t.phoneNumber} value={resumeData.header.phone} onChange={e => handleGenericChange('header', 'phone', e.target.value)} />
                            <Input label={t.address} value={resumeData.header.address} onChange={e => handleGenericChange('header', 'address', e.target.value)} className="md:col-span-2" />
                        </div>
                    </Section>
                    ...
                    <Section title={t.education} isOpen={openSections.education} onToggle={() => handleToggleSection('education')}>
                        <Input label={t.degree} value={resumeData.education.education} onChange={e => handleGenericChange('education', 'education', e.target.value)} placeholder="e.g., Bachelor of Science in Computer Science"/>
                        <Input label={t.school} value={resumeData.education.school} onChange={e => handleGenericChange('education', 'school', e.target.value)} placeholder="e.g., State University"/>
                         <div className="grid grid-cols-3 gap-4">
                            <Input label={t.city} value={resumeData.education.city} onChange={e => handleGenericChange('education', 'city', e.target.value)} />
                            <Input label={t.startDate} value={resumeData.education.startDate} onChange={e => handleGenericChange('education', 'startDate', e.target.value)} placeholder="e.g., Aug 2016" />
                            <Input label={t.endDate} value={resumeData.education.endDate} onChange={e => handleGenericChange('education', 'endDate', e.target.value)} placeholder="e.g., May 2020" />
                        </div>
                        <Textarea label={t.description} value={resumeData.education.description} onChange={e => handleGenericChange('education', 'description', e.target.value)} rows={2} />
                    </Section>
